...
{
    public class ReplyUserMessageCommandValidator : AbstractValidator<ReplyUserMessageCommand>
    {
        private readonly ISolicoDbContext _context;
        private readonly ILocalization _localization;

        public ReplyUserMessageCommandValidator(ISolicoDbContext context, ILocalization localization)
        {
            _context = context;
