...
{
    public class SettleCommandHandler  : IRequestHandler<SettleCommand,Result>
    {
        private readonly ISolicoDbContext _context;
        private readonly ILocalization _localization;

        public SettleCommandHandler(ISolicoDbContext context, ILocalization localization)
        {
            _context = context;
            _localization = localization;
        }

        public async Task<Result> Handle(SettleCommand request, CancellationToken cancellationToken)
        {
            var consult =
            ...
            consult.IsSettle = !consult.IsSettle;
